	...
	public override serialize(): Buffer {
		...
		switch (this.type) {
			case TelemetryEventType.AchievementAwarded: {
				this.writeVarInt(
					(this.event_data as EventData["AchievementAwarded"]).achievementId,
				);
				break;
			}
			...
			case TelemetryEventType.PortalBuilt: {
				this.writeVarInt(
					(this.event_data as EventData["PortalBuilt"]).dimensionId,
				);
				break;
			}
			...
			case TelemetryEventType.BellBlockUsed: {
				this.writeVarInt(
					(this.event_data as EventData["BellBlockUsed"]).itemId,
				);
				break;
			}
			case TelemetryEventType.ActorDefinition: {
				this.writeVarString(
					(this.event_data as EventData["ActorDefinition"]).eventName,
				);
				break;
			}
			...
			case TelemetryEventType.TargetBlockHit: {
				this.writeVarInt(
					(this.event_data as EventData["TargetBlockHit"]).redstoneLevel,
				);
				break;
			}
			...
			case TelemetryEventType.WaxedOrUnwaxedCopper: {
				this.writeVarInt(
					(this.event_data as EventData["WaxedOrUnwaxedCopper"])
			...
			case TelemetryEventType.CodeBuilderRuntimeAction: {
				this.writeVarString(
					(this.event_data as EventData["CodeBuilderRuntimeAction"])
