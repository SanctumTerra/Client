...
import { CraftingDataEntryType, ShapelessRecipe } from "@serenityjs/protocol";
import {
	MultiRecipe,
	...
	FurnanceAuxRecipe,
	FurnanceRecipe,
} from "./smithing-transform-recipe";
import type { ShulkerBoxRecipe } from "./smithing-transform-recipe";
...
class CraftingDataEntry extends DataType {
	...
	public static read(stream: BinaryStream): Array<CraftingDataEntry> {
		...
		for (let index = 0; index < count; index++) {
			...
			const entry = new CraftingDataEntry(
				type,
				shapeless,
				shaped,
				furnace,
